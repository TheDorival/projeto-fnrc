...
Em cada uma das 8 VMs foram criados o usuário administrador (`adminifal`) e os usuários individuais de todos os integrantes do grupo, conforme a lista oficial da disciplina.
