...
[g2-pc1-vm1.yaml](/configs/netplan/g2-pc1-vm1.yaml)

[g2-pc1-vm2.yaml](/configs/netplan/g2-pc1-vm2.yaml)
...
```bash
sudo hostnamectl set-hostname g2-pc1-vm2.grupo2-bsi-26-1.maceio.lab
```
...
```bash
ssh daniel.lage@192.168.26.21
# ssh por ip para o user1 no PC3 VM1
```
...
```bash
ping iago.henrique@g2-pc2-vm1
# ssh por fndq para o user2 no PC2 VM1
```
