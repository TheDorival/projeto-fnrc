...
[g2-pc2-vm1.yaml](/configs/netplan/g2-pc2-vm1.yaml)

[g2-pc2-vm2.yaml](/configs/netplan/g2-pc2-vm2.yaml)
...
```bash
sudo hostnamectl set-hostname g2-pc2-vm1.grupo2-bsi-26-1.maceio.lab
```

```bash
sudo hostnamectl set-hostname g2-pc2-vm2.grupo2-bsi-26-1.maceio.lab
```
...
```bash
ssh iago.henrique@192.168.26.23
# ssh por ip para o user2 no PC4 VM1
```
...
```bash
ping gabriel.cruz@g2-pc3-vm1
# ssh por fndq para o user3 no PC3 VM1
```
