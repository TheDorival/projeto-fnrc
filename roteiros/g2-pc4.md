...
[g2-pc4-vm1.yaml](/configs/netplan/g2-pc4-vm1.yaml)

[g2-pc4-vm2.yaml](/configs/netplan/g2-pc4-vm2.yaml)
...
```bash
sudo hostnamectl set-hostname g2-pc4-vm1.grupo2-bsi-26-1.maceio.lab
```

```bash
sudo hostnamectl set-hostname g2-pc4-vm2.grupo2-bsi-26-1.maceio.lab
```
...
# ssh por ip para o user4 no PC2 VM1
```
...
```bash
ping gabriel.cruz@g2-pc1-vm1
# ssh por fndq para o user1 no PC1 VM1
```
